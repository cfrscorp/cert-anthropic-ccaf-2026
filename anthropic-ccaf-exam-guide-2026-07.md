...
This guide is the authoritative reference for candidates preparing to sit the exam. It describes the exam content, lists the domains and task statements tested, provides sample questions, and recommends preparation strategies. Read it in full before scheduling your exam.
...
The exam uses scenario-based questions. Each scenario presents a realistic production context that frames a set of questions. During the exam, 4 scenarios are presented and picked at random from the full set of the 6 scenarios below.
...
Each domain below lists the task statements tested, with the knowledge and skills measured against each. Exam items are written against these objectives.
...
## 11. Registration and Scheduling
...
Candidates who fail to appear for a scheduled exam, or who arrive after the permitted late-arrival window, forfeit the exam fee and must re-register. Cancellation and rescheduling deadlines are described in Section 11.

---

## 13. Exam-Day Experience and Rules of Conduct
...
## 14. Confidentiality and Non-Disclosure Agreement
...
## 15. Credential Maintenance and Recertification

The Claude Certified Architect – Foundations credential is valid for 12 months from the date it is awarded. Because the underlying technology evolves rapidly, the credential is time-limited so that holders maintain current knowledge.
...
Holders remain subject to the rules of conduct described in Section 13.

---

## 16. Candidate Support, Appeals, and Privacy
